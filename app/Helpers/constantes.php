...
define('CLASSES_DASH_INPUT_BUSCA', 'block w-full border-0 px-6 py-2 text-gray-900 ring-1 ring-inset ring-gray-200 focus:ring-1 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 outline-none placeholder:text-gray-400 bg-white rounded-md shadow-sm');
