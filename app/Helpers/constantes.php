...
// Login
define('CLASSES_LOGIN_INPUT', 'block w-full border-0 px-6 py-4 text-gray-900 ring-1 ring-inset ring-gray-200 focus:ring-1 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 outline-none placeholder:text-gray-400 bg-gray-50 rounded-md shadow-sm');
...
// Dashboard
define('CLASSES_DASH_INPUT', 'block w-full border-0 px-6 py-4 text-gray-900 ring-1 ring-inset ring-gray-200 focus:ring-1 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 outline-none placeholder:text-gray-400 bg-gray-50 rounded-md shadow-sm');
...
define('CLASSES_DASH_INPUT_BUSCA_GRANDE', 'block w-full text-black px-6 py-4 sm:text-md font-light sm:leading-6 outline-none rounded-md input-busca');
...
define('CLASSES_DASH_TEXTAREA', 'block w-full border-0 px-6 py-4 h-56 text-gray-900 ring-1 ring-inset ring-gray-200 focus:ring-1 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 outline-none placeholder:text-gray-400 bg-gray-50 rounded-md shadow-sm');
...
define('CLASSES_DASH_BUTTON_LIMPAR', 'border-dashed border border-slate-300 w-full w-max flex justify-center bg-gray-50 hover:bg-gray-50/75 px-6 py-2 text-sm text-gray-600 rounded-md shadow-sm');
