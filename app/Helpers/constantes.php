...
define('CLASSES_DASH_INPUT_BUSCA_GRANDE', 'border border-gray-500 block w-full text-black px-6 py-4 sm:text-md font-light sm:leading-6 outline-none rounded-lg hover:shadow-lg focus:shadow-lg input-busca');
