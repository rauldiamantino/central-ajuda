...
define('CLASSES_DASH_INPUT_BUSCA_GRANDE_EFEITO', 'px-6 py-4 text-white focus:text-gray-600 placeholder-white font-extralight focus:placeholder-gray-600 rounded-lg outline-none ring-none transition-all shadow-md w-full focus:bg-white bg-black/15 hover:shadow-lg focus:shadow-lg input-busca-efeito');
