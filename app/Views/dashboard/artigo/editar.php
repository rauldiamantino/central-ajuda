<div class="relative w-full min-h-full flex flex-col bg-white p-4">
  ...
  <div class="w-full flex flex-col gap-10">
    ...
    <form class="flex flex-col gap-4 w-1/2 min-w-96">
      ...
      <div class="flex flex-col items-end gap-4 p-4 hidden conteudo-imagem-adicionar">
        <input type="file" accept="image/*" name="url" id="conteudo-conteudo" class="hidden">

        <label for="conteudo-conteudo" class="w-full flex items-center justify-center cursor-pointer border border-gray-300 bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition-colors">
