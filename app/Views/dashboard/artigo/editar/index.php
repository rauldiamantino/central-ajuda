<div class="relative w-full min-h-full flex flex-col bg-white p-4">
  <h2 class="text-2xl font-semibold mb-4">Editar artigo <a href="/<?php echo $this->usuarioLogadoSubdominio ?>/artigo/<?php echo $artigo['Artigo.id'] ?>" target="_blank" class="text-gray-400 font-light italic hover:underline">#<?php echo $artigo['Artigo.id']; ?></a></h2>
