<div class="mb-10 relative w-full h-max flex flex-col">
  <div class="mb-4 w-full flex flex-col lg:flex-row justify-between items-start lg:items-center">
    <div class="mb-5 w-full h-full flex flex-col justify-end">
      <h2 class="text-3xl font-semibold flex flex-wrap sm:gap-2 items-end">Editar artigo <a href="/<?php echo $this->usuarioLogado['subdominio']; ?>/artigo/<?php echo $artigo['Artigo']['id'] ?>" target="_blank" class="py-1 text-sm text-gray-400 font-light italic hover:underline">(Artigo #<?php echo $artigo['Artigo']['id']; ?>)</a></h2>
    ...
    <div class="py-2 w-full h-full flex gap-2 items-start justify-end">
      ...
      <div class="relative text-sm">
        ...
        <ul class="z-10 absolute top-12 right-0 md:-right-10 border border-slate-300 lg:mx-10 flex flex-col justify-center bg-white text-gray-600 rounded-md shadow hidden menu-auxiliar menu-auxiliar-artigo">
          ...
          <li class="px-4 py-3">
            <button type="button" class="flex gap-3 items-center text-red-800 js-dashboard-artigos-remover" data-artigo-id="<?php echo $artigo['Artigo']['id'] ?>" data-empresa-id="<?php echo $artigo['Artigo']['empresa_id'] ?>">
