<form method="POST" action="<?php echo baseUrl('/' . $this->usuarioLogado['subdominio'] . '/d/artigo/' . $artigo['Artigo']['id']); ?>" class="border border-slate-300 w-full md:min-w-96 flex flex-col gap-4 p-4 rounded-lg shadow bg-white">
