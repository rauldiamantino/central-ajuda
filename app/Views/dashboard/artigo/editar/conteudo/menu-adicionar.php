    ...
    <div class="flex flex-col gap-6 w-full form-conteudo">
      ...
      <div class="w-full px-2 flex gap-5 flex-col md:flex-row conteudo-botoes-adicionar">
        <div class="w-full flex justify-between md:justify-start flex-wrap sm:flex-nowrap gap-5 md:gap-8">
          <a href="<?php echo baseUrl('/' . $this->usuarioLogado['subdominio'] . '/dashboard/conteudo/adicionar?artigo_id=' . $artigo['Artigo']['id'] . '&tipo=1&referer=' . $botaoVoltar); ?>" class="w-max flex gap-2 items-center justify-center text-black text-sm hover:underline conteudo-btn-texto-adicionar">
