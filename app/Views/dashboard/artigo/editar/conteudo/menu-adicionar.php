    ...
    <div class="flex flex-col gap-6 w-full form-conteudo">
      ...
      <div class="w-full px-2 flex gap-5 flex-col md:flex-row conteudo-botoes-adicionar">
        <div class="w-full flex justify-between md:justify-start gap-5 md:gap-8">
          <a href="/<?php echo $this->usuarioLogado['subdominio'] ?>/dashboard/conteudo/adicionar?artigo_id=<?php echo $artigo['Artigo.id'] ?>&tipo=1" class="w-max flex gap-2 items-center justify-center text-black text-sm hover:underline conteudo-btn-texto-adicionar">
          ...
          <a href="/<?php echo $this->usuarioLogado['subdominio'] ?>/dashboard/conteudo/adicionar?artigo_id=<?php echo $artigo['Artigo.id'] ?>&tipo=2" class="w-max flex gap-2 items-center justify-center hover:underline text-black text-sm conteudo-btn-imagem-adicionar">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          ...
          <a href="/<?php echo $this->usuarioLogado['subdominio'] ?>/dashboard/conteudo/adicionar?artigo_id=<?php echo $artigo['Artigo.id'] ?>&tipo=3" class="w-max flex gap-2 items-center justify-center hover:underline text-black text-sm conteudo-btn-video-adicionar">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
