<div class="mb-4 w-full select-none flex flex-col gap-2 bg-white rounded-md">
  ...
  <?php foreach ($conteudos as $linha): ?>
    <div class="flex items-center gap-1 w-full" data-conteudo-ordem="<?php echo $linha['Conteudo']['ordem'] ?>" data-conteudo-id="<?php echo $linha['Conteudo']['id'] ?>">
