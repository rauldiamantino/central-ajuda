  ...
  <div class="w-full lg:w-1/2">
    ...
    <?php if ($conteudo['Conteudo.tipo'] == 1) { ?>
      <div class="border border-slate-200 p-4 md:w-full rounded-lg shadow editor-container">
        <form method="POST" action="/<?php echo $this->usuarioLogado['subdominio'] ?>/d/conteudo/<?php echo $conteudo['Conteudo.id'] ?>" class="flex flex-col items-end gap-2 editor-container__editor form-conteudo-texto-editar" enctype="multipart/form-data">
          ...
          <div class="w-full">
            ...
            <input type="text" id="conteudo-editar-texto-titulo" name="titulo" class="mt-1 p-2 block w-full border border-gray-300 rounded-md" value="<?php echo $conteudo['Conteudo.titulo'] ?>">
          </div>
          ...
          <div class="sticky bottom-0 py-4 w-full h-max flex flex-col lg:flex-row justify-between gap-4 bg-white">
            ...
            <div class="flex gap-4 bg-white">
              <a href="/<?php echo $this->usuarioLogado['subdominio'] ?>/dashboard/artigo/editar/<?php echo $conteudo['Conteudo.artigo_id'] ?>" class="py-2 px-6 w-full lg:w-max border border-slate-400 flex gap-2 items-center justify-center hover:bg-slate-50 text-gray-700 text-xs rounded-lg modal-texto-editar-btn-cancelar">Voltar</a>
    ...
    <?php if ($conteudo['Conteudo.tipo'] == 2) { ?>
      <div class="border border-slate-200 p-4 md:w-full rounded-lg shadow modal-conteudo-imagem-editar">
        <form method="POST" action="/<?php echo $this->usuarioLogado['subdominio'] ?>/d/conteudo/<?php echo $conteudo['Conteudo.id'] ?>" class="flex flex-col items-end gap-2" enctype="multipart/form-data" data-artigo-id=<?php echo $conteudo['Conteudo.artigo_id'] ?> data-empresa-id=<?php echo $conteudo['Conteudo.empresa_id'] ?>>
          <input type="hidden" name="_method" value="PUT">
          <input type="hidden" name="artigo_id" value="<?php echo $conteudo['Conteudo.artigo_id'] ?>">
          ...
          <div class="w-full">
            ...
            <input type="text" id="conteudo-editar-imagem-titulo" name="titulo" class="mt-1 p-2 block w-full border border-gray-300 rounded-md" value="<?php echo $conteudo['Conteudo.titulo'] ?>">
          </div>
          ...
          <div class="sticky bottom-0 py-4 w-full h-max flex flex-col lg:flex-row justify-between gap-4 bg-white">
            ...
            <div class="flex gap-4">
              <a href="/<?php echo $this->usuarioLogado['subdominio'] ?>/dashboard/artigo/editar/<?php echo $conteudo['Conteudo.artigo_id'] ?>" class="py-2 px-6 w-full lg:w-max border border-slate-400 flex gap-2 items-center justify-center hover:bg-slate-50 text-gray-700 text-xs rounded-lg modal-conteudo-imagem-btn-cancelar">Voltar</a>
    ...
    <?php if ($conteudo['Conteudo.tipo'] == 3) { ?>
      <div class="border border-slate-200 p-4 md:w-full rounded-lg shadow modal-conteudo-video-editar">
        <form method="POST" action="/<?php echo $this->usuarioLogado['subdominio'] ?>/d/conteudo/<?php echo $conteudo['Conteudo.id'] ?>" class="flex flex-col items-end gap-2" enctype="multipart/form-data">
          <input type="hidden" name="_method" value="PUT">
          <input type="hidden" name="artigo_id" value="<?php echo $conteudo['Conteudo.artigo_id'] ?>">
          ...
          <div class="w-full">
            ...
            <input type="text" id="conteudo-editar-video-titulo" name="titulo" class="mt-1 p-2 block w-full border border-gray-300 rounded-md" value="<?php echo $conteudo['Conteudo.titulo'] ?>">
          </div>
          <input type="text" name="url" id="conteudo-editar-video-url" class="border border-gray-300 w-full p-2 rounded-lg text-sm" placeholder="https://www.youtube.com/watch?v=00000000000" value="<?php echo $conteudo['Conteudo.url'] ?>">
          <div class="sticky bottom-0 py-4 w-full h-max flex flex-col lg:flex-row justify-between gap-4 bg-white">
            <div class="flex gap-4 bg-white">
              <label class="flex items-start gap-2 cursor-pointer">
                <input type="hidden" name="titulo_ocultar" value="0">
            ...
            <div class="flex gap-4">
              <a href="/<?php echo $this->usuarioLogado['subdominio'] ?>/dashboard/artigo/editar/<?php echo $conteudo['Conteudo.artigo_id'] ?>" class="py-2 px-6 w-full lg:w-max border border-slate-400 flex gap-2 items-center justify-center hover:bg-slate-50 text-gray-700 text-xs rounded-lg modal-conteudo-video-btn-cancelar">Voltar</a>
