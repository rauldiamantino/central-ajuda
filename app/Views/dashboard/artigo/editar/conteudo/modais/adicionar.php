...
<dialog class="relative pt-4 px-4 w-full sm:w-[1000px] rounded-lg shadow editor-container modal-conteudo-texto-adicionar">
  <form method="POST" action="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/d/conteudo" class="flex flex-col items-end gap-2 editor-container__editor" enctype="multipart/form-data">
...
<dialog class="p-4 w-full sm:w-[600px] rounded-lg shadow modal-conteudo-imagem-adicionar">
  <form method="POST" action="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/d/conteudo" class="flex flex-col items-end gap-2 form-conteudo-imagem-adicionar" enctype="multipart/form-data" data-artigo-id=<?php echo $artigo['Artigo.id'] ?> data-empresa-id=<?php echo $artigo['Artigo.empresa_id'] ?>>
    <input type="hidden" name="artigo_id" value="<?php echo $artigo['Artigo.id'] ?>">
...
<dialog class="p-4 w-full sm:w-[600px] rounded-lg shadow modal-conteudo-video-adicionar">
  <form method="POST" action="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/d/conteudo" class="flex flex-col items-end gap-2" enctype="multipart/form-data">
    <input type="hidden" name="artigo_id" value="<?php echo $artigo['Artigo.id'] ?>">
