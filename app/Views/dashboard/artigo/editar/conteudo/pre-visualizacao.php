      ...
      <?php if ($conteudos) { ?>
        <?php foreach ($conteudos as $chave => $linha) : ?>
          <div class="relative p-1 w-full h-full border-2 border-transparent group hover:border-black rounded">
            ...
            <div class="w-max absolute top-1/2 -right-12 transform -translate-y-1/2 p-3 gap-5 hidden group-hover:flex flex-col rounded">
              ...
              <button type="button" class="w-max h-max text-red-800 flex items-center hover:text-red-600 text-xs rounded-lg group js-dashboard-conteudo-remover" data-conteudo-id="<?php echo $linha['Conteudo']['id'] ?>" data-conteudo-url="<?php echo $linha['Conteudo']['url'] ?>" data-conteudo-tipo="<?php echo $linha['Conteudo']['tipo'] ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16" class="min-h-full">
