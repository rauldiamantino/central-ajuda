<dialog class="p-4 sm:w-[440px] rounded-lg shadow modal-artigos-alerta-filtro">
  <div class="w-full flex gap-4">
    ...
    <div class="text-left">
      <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-artigos-alerta-filtro-titulo">Ops!</h3>
      <div class="mt-2">
        <p class="text-sm text-gray-500">
          É necessário filtrar por categoria antes de reorganizar
        </p>
      </div>
    </div>
  </div>
