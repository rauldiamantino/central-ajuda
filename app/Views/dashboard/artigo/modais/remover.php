...
<dialog class="p-4 sm:w-[440px] rounded-lg shadow modal-artigo-remover">
  ...
  <div class="mt-4 w-full flex flex-col sm:flex-row gap-3 font-semibold text-xs sm:justify-end justify-center">
    <button type="button" class="border border-slate-400 flex gap-2 items-center justify-center py-2 px-6 hover:bg-slate-50 text-gray-700 rounded-lg modal-artigo-btn-cancelar w-full">Voltar</button>
    <button type="button" class="flex gap-2 items-center justify-center py-2 px-6 bg-red-800 hover:bg-red-600 text-white rounded-lg w-full modal-artigo-btn-remover">Remover</button>
  </div>
</dialog>