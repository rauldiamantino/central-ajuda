      ...
      <tr class="hover:bg-slate-100 divide-x">
        ...
        <?php if (isset($linha['Artigo.id'])) { ?>
          <td class="whitespace-normal p-6 w-32 min-w-max flex gap-2 items-center">
            ...
            <button type="button" class="flex gap-2 items-center justify-center py-2 px-4 bg-red-800 hover:bg-red-600 text-white text-xs rounded-lg js-dashboard-artigos-remover" data-artigo-id="<?php echo $linha['Artigo.id'] ?>" data-empresa-id="<?php echo $linha['Artigo.empresa_id'] ?>">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
