            ...
            <?php if (isset($linha['Artigo.id'])) { ?>
              <?php foreach ($linha as $subChave => $subLinha) : ?>
                ...
                <?php if ($subChave == 'Artigo.titulo') { ?>
                  <td class="py-5 px-4">
                    <a href="/<?php echo $this->usuarioLogado['subdominio'] ?>/dashboard/artigo/editar/<?php echo $linha['Artigo.id'] ?>" class="font-semibold text-gray-700 hover:underline js-dashboard-artigos-editar" data-artigo-id="<?php echo $linha['Artigo.id'] ?>">
                      <?php echo $subLinha ?>
                    </a>
                  </td>
                <?php } ?>
                ...
                <?php if ($subChave == 'Categoria.nome') { ?>
                  <td class="py-5 px-4">
                    <a href="/<?php echo $this->usuarioLogado['subdominio'] ?>/dashboard/categoria/editar/<?php echo $linha['Artigo.categoria_id'] ?>" target="_blank" class="hover:underline">
                      <?php echo $subLinha ?>
                    </a>
                  </td>
                <?php } ?>
