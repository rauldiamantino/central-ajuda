      ...
      <?php foreach ($artigos as $chave => $linha) : ?>
        <tr class="hover:bg-slate-100">
          ...
          <td class="whitespace-normal p-6 w-32 min-w-max flex gap-2 items-center">
            <button type="button" class="flex gap-2 items-center justify-center py-2 px-4 bg-blue-800 hover:bg-blue-600 text-white text-xs rounded-lg js-dashboard-artigos-editar" data-artigo-id="<?php echo $linha['Artigo.id'] ?>">
            ...
            <button type="button" class="flex gap-2 items-center justify-center py-2 px-4 bg-red-800 hover:bg-red-600 text-white text-xs rounded-lg js-dashboard-artigos-apagar" data-artigo-id="<?php echo $linha['Artigo.id'] ?>">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
...
<dialog class="p-4 sm:w-[440px] rounded-lg shadow modal-artigo-apagar">
  <div class="w-full flex gap-4">
    ...
    <div class="text-left">
      <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-artigo-apagar-titulo">Remover artigo</h3>
      <div class="mt-2">
