<div class="relative w-full min-h-full flex flex-col p-4">
  ...
  <div class="w-full flex gap-4">
    ...
    <div class="w-full flex flex-col gap-10">
      <form method="POST" action="<?php echo baseUrl('/' . $this->usuarioLogado['subdominio'] . '/d/artigo'); ?>" class="border border-slate-200 w-full min-w-96 flex flex-col gap-4 p-4 rounded-lg shadow bg-white">
