  ...
  <div class="w-full flex flex-col md:flex-row gap-4">
    ...
    <div class="mb-10 md:mb-0 md:block w-full empresa-bloco-assinatura" data-empresa-assinatura="<?php echo $empresa['Empresa.assinatura_id']; ?>">
      <div class="relative border border-slate-300 w-full min-w-96 flex flex-col p-4 rounded-lg shadow bg-white">
        ...
        <div class="w-full p-2 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <span class="w-full sm:w-2/12 text-xs rounded"><?php echo strtoupper('ID Assinatura') ?></span>
          <div class="border border-slate-200 w-full sm:w-10/12 px-4 py-2 bg-slate-100 rounded">
