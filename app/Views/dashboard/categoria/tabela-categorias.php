            ...
            <?php if (isset($linha['Categoria.id'])) { ?>
              <?php foreach ($linha as $subChave => $subLinha) : ?>
                ...
                <?php if ($subChave == 'Categoria.nome') { ?>
                  <td class="py-5 px-4">
                    <a href="/<?php echo $this->usuarioLogadoSubdominio ?>/dashboard/categoria/editar/<?php echo $linha['Categoria.id'] ?>" class="font-semibold text-gray-700 hover:underline js-dashboard-categorias-editar" data-categoria-id="<?php echo $linha['Categoria.id'] ?>">
                      <?php echo $subLinha ?>
                    </a>
                  </td>
                <?php } ?>
            ...
            <?php if (isset($linha['Categoria.id'])) { ?>
              <td class="py-5 px-4">
                <div class="flex gap-3 md:gap-1 justify-around">
                  <a href="/<?php echo $this->usuarioLogadoSubdominio ?>/dashboard/artigos?categoria_id=<?php echo $linha['Categoria.id'] ?>" target="_blank" class="text-slate-800" title="Filtrar artigos">
