<div class="relative w-full min-h-full flex flex-col bg-white p-4">
  ...
  <div class="w-full flex gap-4">
    <div class="w-full flex flex-col gap-10">
      <form method="POST" action="/d/<?php echo $this->usuarioLogado['empresaId'] ?>/categoria" class="border border-slate-200 w-full min-w-96 flex flex-col gap-4 p-4 rounded-lg shadow">
