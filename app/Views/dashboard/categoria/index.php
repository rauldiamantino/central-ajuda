...
<?php if (! isset($categorias[0]) or empty($categorias[0])) { ?>
  <div class="p-4 w-full flex flex-col gap-4 items-center justify-center">
    ...
    <a href="/dashboard/<?php echo $this->usuarioLogado['empresaId'] ?>/categoria/adicionar" class="w-max flex gap-2 items-center justify-center py-2 px-4 border border-green-800 bg-green-800 hover:bg-green-600 text-white text-xs rounded-lg">Adicionar</a>
  </div>
<?php } ?>