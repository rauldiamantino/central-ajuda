    ...
    <div class="pb-4 md:pb-0 w-full flex flex-col md:flex-row md:justify-between md:items-center">
      ...
      <div class="pt-4 md:pt-0 w-full flex justify-end">
        <div class="py-3 w-full md:w-max flex md:justify-end items-center gap-6 rounded-md">
          ...
          <a href="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/dashboard/categoria/adicionar" class="w-full flex gap-2 items-center justify-center text-black text-sm text-sm hover:underline">
...
<?php if (! isset($categorias[0]) or empty($categorias[0])) { ?>
  <div class="p-4 w-full flex flex-col gap-4 items-center justify-center">
    ...
    <a href="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/dashboard/categoria/adicionar" class="w-max flex gap-2 items-center justify-center py-2 px-4 border border-green-800 bg-green-800 hover:bg-green-600 text-white text-xs rounded-lg">Adicionar</a>
  </div>
<?php } ?>