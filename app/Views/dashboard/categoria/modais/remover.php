...
<dialog class="p-4 sm:w-[440px] rounded-lg shadow modal-categoria-remover">
  ...
  <div class="mt-4 w-full flex flex-col sm:flex-row gap-3 font-semibold text-xs sm:justify-end justify-center">
    <button type="button" class="border border-slate-400 flex gap-2 items-center justify-center py-2 px-3 hover:bg-slate-50 text-gray-700 rounded-lg modal-categoria-btn-cancelar w-full">Voltar</button>
