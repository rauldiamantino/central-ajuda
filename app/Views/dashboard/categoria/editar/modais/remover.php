...
<dialog class="p-4 sm:w-[440px] rounded-lg shadow modal-artigo-remover">
  ...
  <div class="mt-4 w-full flex justify-end gap-2">
    <button type="button" class="<?php echo CLASSES_DASH_BUTTON_VOLTAR; ?> modal-artigo-btn-cancelar">Voltar</button>
    <button type="button" class="<?php echo CLASSES_DASH_BUTTON_REMOVER; ?> modal-artigo-btn-remover">Remover</button>
  </div>
</dialog>