<dialog class="border border-slate-300 w-full md:w-[700px] rounded-md shadow menu-editar-categoria">
  <form method="POST" action="<?php echo '/d/categoria/' . $categoria[0]['Categoria']['id']; ?>" class="w-full flex flex-col gap-4 p-4 rounded-lg shadow bg-white" onsubmit="evitarDuploClique(event)">
    ...
    <div class="w-full flex flex-col gap-4">
      ...
      <div class="p-4 bg-gray-100 rounded-lg">
        ...
        <div class="mt-4 w-full">
          ...
          <input name="meta_titulo" id="meta_titulo" class="<?php echo CLASSES_DASH_INPUT; ?>" value="<?php echo $categoria[0]['Categoria']['meta_titulo']; ?>"></input>
        </div>
        <div class="mt-4 w-full">
          <label for="meta_descricao" class="block text-sm font-medium text-gray-700">Description</label>
          <input name="meta_descricao" id="meta_descricao" class="<?php echo CLASSES_DASH_INPUT; ?>" value="<?php echo $categoria[0]['Categoria']['meta_descricao']; ?>"></input>
        </div>
      </div>
