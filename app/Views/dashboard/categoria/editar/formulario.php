<form method="POST" action="<?php echo baseUrl('/' . $this->usuarioLogado['subdominio'] . '/d/categoria/' . $categoria[0]['Categoria']['id']); ?>" class="border border-slate-300 w-full flex flex-col gap-4 p-4 rounded-lg shadow bg-white">
  ...
  <div class="w-full flex gap-4">
    ...
    <div class="w-full flex flex-col gap-4">
      <div class="w-full">
        ...
        <input type="text" id="categoria-editar-titulo" name="nome" class="<?php echo CLASSES_DASH_INPUT; ?>" value="<?php echo $categoria[0]['Categoria']['nome']; ?>" required autofocus>
      </div>
      <div class="w-full">
