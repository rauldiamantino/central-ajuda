<form method="POST" action="/<?php echo $this->usuarioLogado['subdominio'] ?>/d/categoria/<?php echo $categoria['Categoria.id'] ?>" class="border border-slate-200 w-full min-w-96 flex flex-col gap-4 p-4 rounded-lg shadow">
