    ...
    <div class="pb-4 md:pb-0 w-full flex flex-col justify-center items-start md:flex-row md:justify-between md:items-center">
      ...
      <div class="pt-4 md:pt-0 w-full flex justify-end">
        <div class="py-3 w-full md:w-max flex justify-end items-center gap-6 rounded-md">
          ...
          <span class="w-full md:hidden"></span>
          <a href="/dashboard/usuario/adicionar/<?php echo $this->usuarioLogado['empresaId'] ?>" class="w-full flex gap-2 items-center justify-end text-black text-sm text-sm hover:underline">
...
<?php if (! isset($usuarios[0]) or empty($usuarios[0])) { ?>
  <div class="p-4 w-full flex flex-col gap-4 items-center justify-center">
    ...
    <a href="/dashboard/usuario/adicionar/<?php echo $this->usuarioLogado['empresaId'] ?>" class="w-max flex gap-2 items-center justify-center py-2 px-4 bg-green-800 hover:bg-green-600 text-white text-sm text-xs rounded-lg">Adicionar</a>
  </div>
<?php } ?>