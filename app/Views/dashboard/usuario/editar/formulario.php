...
<form method="POST" action="/<?php echo $this->usuarioLogado['subdominio'] ?>/d/usuario/<?php echo $usuario['Usuario.id'] ?>" class="border border-slate-200 w-full min-w-96 flex flex-col gap-4 p-4 rounded-lg shadow">
  ...
  <div class="w-full flex gap-4 justify-between">
    <div class="flex gap-4">
      <a href="/<?php echo $this->usuarioLogado['subdominio'] ?>/dashboard/usuarios" class="border border-slate-400 flex gap-2 items-center justify-center py-2 px-3 hover:bg-slate-50 text-xs text-gray-700 rounded-lg">Voltar</a>
