...
<form method="POST" action="/d/<?php echo $this->usuarioLogado['empresaId'] ?>/usuario/<?php echo $usuario['Usuario.id'] ?>" class="border border-slate-200 w-full min-w-96 flex flex-col gap-4 p-4 rounded-lg shadow">
