...
<script src="<?php echo baseUrl('/js/dashboard/empresas/logo.js'); ?>" type="module"></script>
<script src="<?php echo baseUrl('/js/dashboard/empresas/favicon.js'); ?>" type="module"></script>
