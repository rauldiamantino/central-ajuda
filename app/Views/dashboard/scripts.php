...
<script src="/js/dashboard/firebase/inicializar.js" type="module"></script>

<!------------------- scripts ------------------->
<script src="/js/dashboard/index.js"></script>
<script src="/js/dashboard/empresas/index.js"></script>
<script src="/js/dashboard/empresas/foto.js" type="module"></script>
...
<script src="/js/dashboard/artigos/index.js" type="module"></script>
...
<script src="/js/dashboard/artigos/conteudos/remover.js" type="module"></script>
<script src="/js/dashboard/artigos/conteudos/editar.js" type="module"></script>
<script src="/js/dashboard/artigos/conteudos/adicionar.js" type="module"></script>