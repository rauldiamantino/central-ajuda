    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/dashboard/<?php echo $this->usuarioLogado['empresaId'] ?>/categorias" class="w-full p-2">
        <div class="flex items-center gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="group-hover:text-black" viewBox="0 0 16 16">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <button type="button"onclick="window.location.href='/logout'" class="w-full p-2">
        <div class="flex items-center gap-3 text-red-800">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="group-hover:text-red-900" viewBox="0 0 16 16">
