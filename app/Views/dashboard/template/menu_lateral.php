<asside class="pt-16 fixed top-0 left-0 z-10 transform -translate-x-full transition-transform duration-100 md:translate-x-0 border-r border-slate-200 flex flex-col justify-between bg-white w-80 md:w-64 h-screen overflow-hidden dashboard-menu-lateral">
  <ul class="flex flex-col gap-3 text-gray-500 px-4 py-6">
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/dashboard" class="w-full p-2">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/dashboard/artigos" class="w-full p-2">
        <div class="flex items-center gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16" class="group-hover:text-black">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/dashboard/categorias" class="w-full p-2">
        <div class="flex items-center gap-3">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/dashboard/usuarios" class="w-full p-2">
        <div class="flex items-center gap-3">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/dashboard/empresa/editar" class="w-full p-2">
        <div class="flex items-center gap-3">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>/dashboard/ajustes" class="w-full p-2">
        <div class="flex items-center gap-3">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/<?php echo $this->buscarUsuarioLogado('subdominio') ?>" target="_blank" class="w-full p-2">
        <div class="flex items-center gap-3">
