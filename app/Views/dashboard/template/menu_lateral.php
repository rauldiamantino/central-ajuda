<div class="fixed border-r border-slate-200 bg-white w-64 h-screen p-4">
  <ul class="flex flex-col gap-4 text-gray-500">
    <li class="p-2 hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
