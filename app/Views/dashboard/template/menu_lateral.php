<asside class="pt-16 fixed top-0 left-0 z-10 transform -translate-x-full transition-transform duration-100 lg:translate-x-0 border-r border-slate-200 flex flex-col justify-between bg-white w-80 md:w-96 lg:w-64 h-screen overflow-hidden dashboard-menu-lateral">
  <ul class="flex flex-col gap-3 text-gray-500 px-4 py-6">
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/dashboard/artigos/<?php echo $this->usuarioLogado['empresaId'] ?>" class="w-full p-2">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/dashboard/categorias/<?php echo $this->usuarioLogado['empresaId'] ?>" class="w-full p-2">
        <div class="flex items-center gap-3">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/dashboard/usuarios/<?php echo $this->usuarioLogado['empresaId'] ?>" class="w-full p-2">
        <div class="flex items-center gap-3">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/dashboard/ajustes/<?php echo $this->usuarioLogado['empresaId'] ?>" class="w-full p-2">
        <div class="flex items-center gap-3">
    ...
    <li class="hover:bg-slate-100 rounded-lg cursor-pointer flex justify-between group">
      <a href="/dashboard/empresa/editar/<?php echo $this->usuarioLogado['empresaId'] ?>" class="w-full p-2">
