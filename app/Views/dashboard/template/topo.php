<header class="py-3 lg:py-4 px-4 sticky top-0 w-full flex items-center justify-between z-20 bg-white shadow xl:bg-transparent xl:shadow-none topo-dashboard">
  <nav class="relative w-full flex gap-10 justify-between">
    ...
    <ul class="border border-slate-300 lg:mx-10 absolute top-20 right-0 flex flex-col justify-center bg-white text-gray-600 rounded-md shadow hidden menu-topo-usuario">
      <li class="px-8 py-5">
        <button type="button" onclick="window.location.href='<?php echo baseUrl('/' . $this->usuarioLogado['subdominio'] . '/dashboard/usuario/editar/' . $this->usuarioLogado['id']); ?>'" class="flex gap-3 items-center hover:text-gray-950">
