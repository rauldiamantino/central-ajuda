<header class="border-b border-slate-200 py-3 lg:py-4 px-4 sticky top-0 w-full flex items-center justify-between bg-white z-10 shadow">
  <nav class="relative w-full bg-white flex gap-10 justify-between">
    ...
    <ul class="border border-slate-300 lg:mx-10 absolute top-20 right-0 flex flex-col justify-center bg-white text-gray-600 rounded-md shadow hidden menu-topo-usuario">
      <li class="px-8 py-5">
        <button type="button" onclick="window.location.href='<?php echo '/dashboard/' . $this->usuarioLogado['empresaId'] . '/usuario/editar/' . $this->usuarioLogado['id']; ?>'" class="flex gap-3 items-center hover:text-gray-950">
      ...
      <li class="px-8 py-5">
        <button type="button" onclick="window.open('<?php echo subdominioDominio($this->usuarioLogado['subdominio']); ?>')" class="flex gap-3 items-center hover:text-gray-950">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16" stroke="currentColor" stroke-width="0.3">
      ...
      <li class="border-t border-slate-200 px-8 py-5">
        <button type="button" onclick="window.location.href='/logout'" class="w-max flex gap-3 items-center text-red-800 hover:text-red-950">
