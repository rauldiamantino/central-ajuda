<div class="mb-10 relative w-full h-max flex flex-col hidden container-assinatura">
  <div class="mb-4 w-full flex flex-col lg:flex-row justify-between items-start lg:items-center">
    <div class="mb-5 w-full h-full flex flex-col justify-end">
      ...
      <p class="text-gray-600">Gerencie seu plano e seu histórico de pagamentos.</p>
    </div>
