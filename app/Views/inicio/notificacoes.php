...
<?php if (isset($notificacaoSucesso)) { ?>
  <div class="fixed left-1/2 bottom-4 w-full md:w-max z-30 pb-4 px-5 sm:px-0 transform -translate-x-1/2 js-inicio-notificacao-sucesso" onload="fecharNotificacao()">
    <div class="bg-green-100 border border-green-500 text-green-700 px-4 py-3 rounded relative shadow" role="alert">
      ...
      <span class="absolute top-0 bottom-0 right-0 md:-right-10 px-4 py-3 js-inicio-notificacao-sucesso-btn-fechar">
...
<?php if (isset($notificacaoErro)) { ?>
  <div class="fixed left-1/2 bottom-4 w-full md:w-max z-30 pb-4 px-5 sm:px-0 transform -translate-x-1/2 js-inicio-notificacao-erro">
    <div class="bg-red-100 border border-red-500 text-red-700 px-4 py-3 rounded relative" role="alert">
      ...
      <?php } ?>
      <span class="absolute top-0 bottom-0 right-0 md:-right-10 px-4 py-3 js-inicio-notificacao-erro-btn-fechar">
...
<?php if (isset($notificacaoNeutra)) { ?>
  <div class="fixed left-1/2 bottom-4 w-full md:w-max z-30 pb-4 px-5 sm:px-0 transform -translate-x-1/2 js-inicio-notificacao-neutra">
    <div class="bg-blue-100 border border-blue-500 text-blue-700 px-4 py-3 rounded relative" role="alert">
      ...
      <?php } ?>
      <span class="absolute top-0 bottom-0 right-0 md:-right-10 px-4 py-3 js-inicio-notificacao-neutra-btn-fechar">
