<footer class="mt-14 w-full text-sm md:text-base px-4 py-16 flex justify-center items-center bg-gray-100">
  ...
  <a href="https://wa.me/5511934332319" target="_blank" class="p-3 hover:scale-110 duration-100 w-max h-max flex items-center justify-center bg-blue-200 fixed bottom-10 right-4 sm:right-6 md:right-10 text-white bg-green-500 rounded-full">
