...
<header class="border-b <?php echo $classesTopoBorda . ' ' . $classesTopoFixo. ' ' . $classesTopoCor ?> z-20 top-0 w-full lg:mx-auto h-24 flex justify-center items-center <?php echo isset($inicio) ? 'py-12' : 'py-20'; ?> md:py-4 px-4 xl:px-0 md:gap-10 transition duration-300 topo-publico">
