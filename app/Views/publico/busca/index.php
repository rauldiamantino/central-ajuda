          ...
          <div class="mb-10 flex flex-col gap-2 publico-artigo-bloco">
            <?php if (isset($linha['Artigo.ativo']) and $linha['Artigo.ativo'] == 1) { ?>
                ...
                <?php if ($linha['Categoria.nome'] and $linha['Artigo.categoria_id']) { ?>
                  <a href="/p/<?php echo $subdominio ?>/categoria/<?php echo $linha['Artigo.categoria_id']; ?>" class="italic hover:underline"><?php echo $linha['Categoria.nome'] ?></a>
                <?php } ?>
              ...
              <h2 class="text-2xl"><a href="/p/<?php echo $subdominio ?>/artigo/<?php echo $linha['Artigo.id'] ?>" class="hover:underline"><?php echo $linha['Artigo.titulo'] ?></a></h2>
            <?php } ?>
          </div>
      <?php endforeach; ?>
