<?php if ($paginasTotal > 1) { ?>
  ...
  <div class="mt-10 sticky inset-x-0 w-full h-max py-2 flex justify-start items-center gap-1 rounded-md">
    <?php if ($pagina > 1) { ?>
      <a href="<?php echo baseUrl('/' . $subdominio . '/buscar?texto_busca=' . $textoBusca . '&pagina=' . $pagina - 1); ?>" class="border border-gray-200 bg-gray-50 hover:bg-gray-200 text-gray-500 hover:text-black p-3 rounded-lg">
    ...
    <form action="<?php echo baseUrl('/' . $subdominio . '/buscar'); ?>" method="get">
