...
<div class="sticky inset-x-0 bottom-0 border-t border-slate-200 w-full h-max py-2 flex justify-center items-center gap-1 bg-white">
  <?php if ($pagina > 1) { ?>
    <a href="/buscar?texto_busca=<?php echo $textoBusca ?>&pagina=<?php echo $pagina - 1 ?>" class="border border-slate-100 bg-slate-100 hover:bg-slate-200 text-gray-500 hover:text-black p-3 rounded-lg">
