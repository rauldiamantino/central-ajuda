  ...
  <div class="w-full mt-6 border-y border-gray-200">
    <div class="w-full p-6 <?php echo isset($feedback) ? ' hidden ' : ''; ?> flex gap-4 flex-col items-center container-feedback-inicio">
      ...
      <div class="w-full h-full flex gap-4 items-center justify-center">
        <button class="text-gray-600 bg-gray-200 hover:scale-110 duration-150 w-12 h-12 p-2 rounded-full btn-feedback flex items-center justify-center feedback btn-feedback" data-feedback="1" onclick="enviarFeedback(<?php echo $artigo['Artigo']['id']; ?>, 1)">
        ...
        <button class="text-gray-600 bg-gray-200 hover:scale-110 duration-150 w-12 h-12 p-2 rounded-full btn-feedback flex items-center justify-center btn-feedback" data-feedback="0" onclick="enviarFeedback(<?php echo $artigo['Artigo']['id']; ?>, 0)">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" class="vazio">
