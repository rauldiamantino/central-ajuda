...
<div class="w-full flex flex-col md:px-12 py-14">
  ...
  <div class="pt-1 w-full italic text-lg font-extralight">
        ...
        <ul class="leading-9 flex flex-col gap-2">
          <?php foreach ($artigos as $chave => $linha): ?>
            <li class="flex gap-2 items-center">
              <a href="<?php echo baseUrl('/' . $subdominio . '/artigo/' . $linha['Artigo']['id']); ?>" class="border border-slate-200 w-full h-full px-4 py-2 hover:bg-slate-100 rounded-md"><?php echo $linha['Artigo']['titulo'] ?></a>
