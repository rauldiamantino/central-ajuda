...
return [
  ...
  'dashboard' => [
    ...
    'GET:/{empresa}/d/buscar_cobrancas'              => ['controlador' => [DashboardAssinaturaController::class,  'buscarCobrancas'],             'permissao' => $suporteTotal],
    ...
    'POST:/{empresa}/d/assinatura'                   => ['controlador' => [DashboardAssinaturaController::class,  'buscarAssinatura'],            'permissao' => $acessoTodos],
  ...
  'GET:/{empresa}/d/assinaturas/gerar/{id}'          => ['controlador' => [DashboardAssinaturaController::class,  'criarAssinaturaAsaas'],        'permissao' => $acessoTodos],
  ],
];